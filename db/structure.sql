...
CREATE INDEX index_users_on_api_token ON users USING hash (api_token);
...
CREATE INDEX index_users_on_auth_token ON users USING hash (auth_token);
...
CREATE INDEX index_users_on_slug ON users USING hash (slug);
