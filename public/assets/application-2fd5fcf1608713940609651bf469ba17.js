...
(function() {
  ...
  bud.widgets.Form = (function(_super) {
    ...
    Form.prototype.initialize = function() {
      ...
      if (this.$container.data('target')) {
        return this.$target = $("[data-identifier=" + (this.$container.data('target')) + "]");
      } else {
        return this.$target = this.$container;
      }
    };

    Form.prototype.on_submit = function() {
      var callbacks, method, params, path, request;
      path = this.$container.attr('action');
      params = this.params();
      callbacks = {
      ...
      method = this.$container.attr('method');
    ...
    Form.prototype.on_success = function() {
      return _.each(this.$container.find('input[data-target]'), function(field) {
        var $field, $target;
        $field = $(field);
        $target = $("[data-identifier=" + ($field.data('target')) + "]");
        return $target.html($field.val());
      });
    };

    Form.prototype.on_replace = function(response) {
      if (this.$target === this.$container) {
        return bud.replace_container(this.$target, response['html']);
      } else {
        return bud.replace_html(this.$target, response['html']);
      }
    };
...
(function() {
  ...
  bud.widgets.Commenter = (function(_super) {
    ...
    Commenter.prototype.on_success = function(response) {
      Commenter.__super__.on_success.apply(this, arguments);
...
(function() {
  ...
  bud.widgets.PopupTrigger = (function(_super) {
    ...
    PopupTrigger.prototype.on_click = function() {
      bud.pub("popup.toggle." + this.target);
      return false;
    };
