class SubscriptionManager < BaseManager
  ...
  def subscribe_to(target)
    ...
    Subscription.new do |subscription|
      ...
      SubscribedFeedEvent.create! target_user: user, target: subscription
      SubscriptionsMailer.subscribed(@subscriber).deliver
    end
  end
  ...
  def unsubscribe(subscription)
    ...
    UnsubscribedFeedEvent.create! target_user: user, target: subscription
    SubscriptionsMailer.unsubscribed(@subscriber).deliver
  end
end
